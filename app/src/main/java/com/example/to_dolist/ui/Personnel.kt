...
import com.example.to_dolist.databinding.FragmentPersonnelBinding
...
class Personnel : Fragment() {
    ...
    private var _binding: FragmentPersonnelBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentPersonnelBinding.inflate(inflater, container, false)
    ...
    private fun viewModelInstances(){
        viewModel.tasksByCategory("Personal").observe(viewLifecycleOwner) { task ->
